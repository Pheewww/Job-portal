...
const categories = [
  { name: 'Job Category', items: ['Design', 'Development', 'Finance', 'Marketing', 'Management', 'Support'] },
  { name: 'Timezone', items: ['North America', 'Europe', 'Asia', 'Africa', 'Australia', 'South America'] },
